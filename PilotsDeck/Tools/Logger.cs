namespace PilotsDeck
{
    ...
    public static class Logger
    {
        ...
        public static string ActionInfo(string address, ActionSwitchType type)
        {
            return $"(Address: {address}) (Type: {type})";
        }

        public static string ActionInfo(string address, int type)
        {
            return ActionInfo(address, (ActionSwitchType)type);
        }
    }
}
