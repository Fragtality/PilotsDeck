...
3. If you want configure the Profile as **Default Profile**, select the **Simulator** it is should be used for.<br/>Default Profiles will be loaded if no matching Aircraft Profile was found.
3. If you configure the Profile for a **specific Aircraft**, enter the **Search-String** to match and click on the Plus-Button.<br/>Aircraft Profiles will be loaded if any of the Search-Strings is contained in the current Aircraft-String received from the Simulator (the matching is case-insensitive)
