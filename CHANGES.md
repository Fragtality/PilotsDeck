...
- Added: `RunEvent` for Global Scripts now works on *ALL* Variable Types (across all Simulators!)
  ...
  - To get only notified when the Value has *changed*, use the new `RunEventChanged` Function
